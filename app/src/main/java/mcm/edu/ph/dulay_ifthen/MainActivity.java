package mcm.edu.ph.dulay_ifthen;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLore.setText("Mayo is better than Ketchup");
    ...
    public void onClick(View view){
        ...
        switch(view.getId()){
            case R.id.btnDecision1:
                txtDecision.setText("I belive mayo is better than ketchup");
                break;

            case R.id.btnDecision2:
                txtDecision.setText("I belive Ketchup is better than Mayo");
                break;
